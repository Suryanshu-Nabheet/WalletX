                ...
                <div className="bg-gray-900 p-4 rounded-xl border border-gray-700">
                    ...
                    <div className="flex space-x-4">
                        ...
                        <div className="bg-gray-800 px-3 py-1 rounded-lg flex items-center space-x-2 border border-gray-700">
                            <span className="font-bold text-white">{chainConfig?.nativeCurrency?.symbol || 'ETH'}</span>
                        </div>
                    </div>
                </div>
                ...
                {quote && (
                    <div className="bg-gray-800/50 p-4 rounded-xl border border-gray-700/50 text-sm space-y-2">
                        <div className="flex justify-between">
                            ...
                            <span className="text-white">1 {chainConfig?.nativeCurrency?.symbol} = {parseFloat(ethers.formatEther(quote.toAmount)) / parseFloat(amount)} Token</span>
                        </div>
                        <div className="flex justify-between">
